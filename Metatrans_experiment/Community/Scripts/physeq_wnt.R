...
#Veech co-occurrence probability calculation (Veech, 2013)
...
df_meta$Region <- factor(df_meta$Region, levels = c("RiberaGuadiana", "LaMancha", "Madrid", "Valdepeñas", "LaRioja"))

...
setwd("C:/Users/Laboratorio14/OneDrive - Universidad Complutense de Madrid (UCM)/Wineteractions/RNAseq Experiment/Community/")

#load("dada2_wnt.RData")
...
taxa.cut <- assignTaxonomy(seqtab.nochim, 
                           "sh_general_release_10.05.2021/sh_general_release_dynamic_10.05.2021.fasta")

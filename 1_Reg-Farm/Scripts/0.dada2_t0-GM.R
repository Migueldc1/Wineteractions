...
setwd("C:/Users/Miguel de Celis/OneDrive - Universidad Complutense de Madrid (UCM)/Wineteractions/GitHub/Wineteractions/1_Reg-Farm/")
...
#Set cutadapt path
cutadapt <- "C:/Users/Miguel de Celis/Documents/R/cutadapt.exe"
...
#
#### SAVE DATA ####
save.image("dada2_t0-GM.RData")

saveRDS(taxa.cut, "Outputs/tax_t0-GM.rds")
saveRDS(seqtab.nochim, "Outputs/ASV_t0-GM.rds")
write.table(track.cut, "Outputs/track_t0-GM.txt", sep = "\t", dec = ",")
